...
Se [Jämföra at.js-biblioteket med Web SDK](https://experienceleague.adobe.com/en/docs/experience-platform/web-sdk/personalization/adobe-target/web-sdk-atjs-comparison){target=_blank} om du vill veta mer om skillnaderna mellan de två implementeringsmetoderna.