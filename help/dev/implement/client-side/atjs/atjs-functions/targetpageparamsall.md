...
description: Använd [!UICONTROL targetPageParamsAll()] funktionen för [!DNL Adobe Target] at.js JavaScript-bibliotek för att bifoga parametrar till alla mbox-filer utanför begärandekoden.
title: Hur jag använder [!UICONTROL targetPageParamsAll()] Funktion?
feature: at.js
...
Du kan skicka in parametrar till target-global-mbox med [!UICONTROL targetPageParamsAll()] på något av följande sätt:
