...
Mer information finns i [Målbibliotek för JavaScript](https://experienceleague.adobe.com/docs/target/using/introduction/how-target-works.html?lang=sv-SE#libraries).
