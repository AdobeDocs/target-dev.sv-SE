...
>[!NOTE]
>
>Utöver den här artikeln innehåller [Adobe Target Business Practitioner](https://experienceleague.adobe.com/docs/target/using/target-home.html){target=_blank} detaljerad information om [Målrekommendationer](https://experienceleague.adobe.com/docs/target/using/recommendations/recommendations.html){target=_blank}.
...
Mer information om Cart-baserade rekommendationer finns i [Cart-Based](https://experienceleague.adobe.com/docs/target/using/recommendations/criteria/base-the-recommendation-on-a-recommendation-key.html?lang=en#cart-based) i *[!DNL Adobe Target]Business Practitioner Guide*.
...
Uteslut alla objekt på global nivå som du aldrig vill rekommendera en besökare. Se [Undantag](https://experienceleague.adobe.com/docs/target/using/recommendations/entities/exclusions.html) i *[!DNL Adobe Target]Business Practitioner-handboken*.
...
![Sidan Rekommendationsinställningar](/help/dev/implement/recommendations/assets/recs_settings.png)
