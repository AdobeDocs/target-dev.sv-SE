---
title: Hämta, lagra och uppdatera artikeldefekten för beslutsregler på enheter via JSON-nyttolast
description: Detta är bäst om ditt program är strukturerat på ett sätt som kräver att SDK initieras för varje fil där SDK-metoder används.
feature: APIs/SDKs
...
1. Installera SDK
1. Initiera SDK
1. Lagra och använda JSON-nyttolasten
