---
title: Översikt över exempelappar
description: Se [!DNL Adobe Target] exempelappar för Node.js, Java, .NET och Python.
feature: APIs/SDKs
...
[Exempel på .NET SDK-användningsapp](https://github.com/adobe/target-dotnet-sdk/blob/main/SampleApp)

## Python

[Exempelapp för Python SDK-användning](https://github.com/adobe/target-python-sdk/blob/main/samples)
